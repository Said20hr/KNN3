<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4 border-dark">
                ...
                <x-jet-label for="photo" value="{{ __('الصورة الشخصية') }}" />
       ...
       <div class="w-full mb-3">
            <x-jet-label for="lastname" value="{{ __('اللقب') }}" />
       ...
       <!-- Birth place -->
            <div class="w-full mb-3">
           <x-jet-label for="birth_place" value="{{ __('مكان الميلاد ') }}" />
