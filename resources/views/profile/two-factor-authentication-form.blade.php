<x-jet-action-section>
    <x-slot name="title">
        {{ __('(Two Factor Authentication)  المصادقة الثنائية ') }}
    </x-slot>
    ...
    <x-slot name="content">
        @if ($this->enabled)
        <h3 class="text-xl font-weight-bold text-green-600">
            {{ __('المصادقة الثنائية مغعلة. ') }}
        </h3>
        @else
            <h3 class="text-xl font-weight-bold text-red-500">
                {{ __('المصادقة الثنائية غير مغعلة. ') }}
            </h3>
        @endif
