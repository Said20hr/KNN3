            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-left text-right">
                    <div class=" dropdown-header noti-title">
                        <h6 class="text-overflow m-0">{{ __('مرحبا!') }}</h6>
                    </div>
        ...
        <form class="navbar-search navbar-search-dark form-inline ml-5 d-none d-md-flex m-lg-auto">
            <div class="form-group mb-0">
                <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control text-right" placeholder="ابحث" type="text">
                </div>
            </div>
        </form>
        <!-- User -->
        <a class="h2 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="{{ route('home') }}">{{ __('لوحة التحكم') }}</a>
    </div>
</nav>
