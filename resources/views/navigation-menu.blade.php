        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-jet-nav-link href="{{route('messages')}}" :active="request()->routeIs('messages')">
                    <h2 class="font-semibold text-xl text-gray-600 leading-tight mx-3 {{ (request()->is('user/messages')) ? 'text-indigo-600 font-weight-bolder' : 'fw-medium' }}">
                        الرسائل و الاستفسارات
                    </h2>
                </x-jet-nav-link>
                <x-jet-nav-link href="{{route('home')}}">
                    <h2 class="font-semibold text-xl text-gray-600 leading-tight mx-3">
                       الاخبار
                    </h2>
                </x-jet-nav-link>
