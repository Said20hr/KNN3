...
<head>
    ...
    <meta name="description" content="Ruya Motion" />
    <meta name="author" content="" />
    <link rel="icon" type="image/png" sizes="16x16" href="assets/imgs/logos/fav-3.svg" />

    <title>{{ 'Ruya Motion' }}</title>
...
<body>
@include('motion.includes.motion-header')
<div class="font-sans text-gray-900 antialiased">
    {{ $slot }}
</div>
@include('motion.includes.motion-footer')
@stack('modals')
