            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg" dir="rtl">
                ...
                <div class="container ">
                    ...
                    <div class="p-6 sm:px-20 bg-white-100 border-b border-gray-300">
                        ...
                        <div class="sm:flex lg:block justify-between bg-white-100 bor-r5 p-6 mb-5 mt-5 text-center justify-center">
                            <div class="sm:pb-4">
                                ...
                                <div class="flex justify-center py-6 text-center">
                            ...
                            <div class="sm:pb-4">
                                ...
                                @else
                                    <div class="flex justify-center  py-6 text-green-600">
                                        <div class="fs-18 font-weight-bold m-lr-7 text-red-600">
                                            معطل
                                        </div>
                                    </div>
                                @endif
